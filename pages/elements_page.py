...
from locators.elements_page_locator import TextPageBoxLocators, CheckPageBoxLocators
from pages.Base_Page import BasePage


class TextBoxPages(BasePage):
    locators = TextPageBoxLocators()
...
class CheckBoxPages(BasePage):
    locators = CheckPageBoxLocators()
